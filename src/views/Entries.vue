...
const textRemoveAllSystem = computed(() => i18n.global.t('actions.delete'))
...
async function removeAll() {
  const btnCloseModal = document.querySelector('#modalRemoveAll div.modal-header button')
  btnCloseModal.click();
...
async function exportExcel(){
  ...
  const input = document.getElementById('itemBusca')
  hideElementById('searchTextRequired')
  displayElementById('loadingExport')
  searchForm.searchItem = input.value
  searchForm.searchOnlyCurrentMonth = document.getElementById('searchOnlyCurrentMonth').checked
  await entriesStore.exportExcel(searchForm)
  hideElementById('loadingExport')
}
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row" style="border: 1px solid lightgray;border-radius: 1%;padding-top: .40%;">
              ...
              <div class="col-1">
                <button class="btn btn-info" id="bth-export" @click="exportExcel()" :title="$t('export')">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M5.884 6.68a.5.5 0 1 0-.768.64L7.349 10l-2.233 2.68a.5.5 0 0 0 .768.64L8 10.781l2.116 2.54a.5.5 0 0 0 .768-.641L8.651 10l2.233-2.68a.5.5 0 0 0-.768-.64L8 9.219l-2.116-2.54z"/>
                    <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2M9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/>
                  </svg>
                  <span id="loadingExport" style="display: none;" class="spinner-border spinner-border-sm mr-1">
                  </span>
                </button> 
              </div>
              <div class="col-1 mb-2">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-floating">
                  <input type="hidden" style="display: none;" id="textRemoveAllSystem" :value="textRemoveAllSystem"/>
                  
                  <input type="text" ref="inputRef" @keyup="onKeyUpDeleteAll" class="form-control" id="textDeleteAll" 
                   placeholder="{{$('actions.deleteAllPrompt')}}"
                  v-model="userTextRemoveAll" />
                  <label for="textDeleteAll">{{ $t('actions.deleteAllPrompt', { deleteWord: $t('actions.delete') }) }}</label>
                </div>
              </div>
